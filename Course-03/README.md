...
| Pasta | Conteúdo |
|-------|----------|
| [`01-built-in-data-types`](01-basics/01-built-in-data-types/) | Tipos de dados nativos: atoms, booleans, números, strings, listas, mapas, tuplas e keyword lists |
| [`02-modules-functions`](01-basics/02-modules-functions/) | Definição de módulos e funções nomeadas |
| [`03-functions-arity-guards-clauses`](01-basics/03-functions-arity-guards-clauses/) | Aridade, guards e cláusulas de função |
| [`04-lambda-functions`](01-basics/04-lambda-functions/) | Funções anônimas (lambdas) e closures |
...
| Pasta | Conteúdo |
|-------|----------|
| [`01-recursion`](02-iterations/01-recursion/) | Recursão básica: fatorial e map recursivo |
| [`02-recursion-lists`](02-iterations/02-recursion-lists/) | Recursão sobre listas: encontrando o valor máximo |
| [`03-tail-call-optimization`](02-iterations/03-tail-call-optimization/) | Otimização de chamada de cauda (TCO) com acumulador |
| [`04-enum-collections`](02-iterations/04-enum-collections/) | Módulo `Enum`, `List`, `Map` e keyword lists |
| [`05-streams`](02-iterations/05-streams/) | Processamento lazy com o módulo `Stream` |
| [`06-streams-files`](02-iterations/06-streams-files/) | Leitura lazy de arquivos com `File.stream!` |
| [`07-comprehensions`](02-iterations/07-comprehensions/) | Compreensões de lista com `for` |
...
| Pasta | Conteúdo |
|-------|----------|
| [`01-conditionals`](03-control-flow/01-conditionals/) | Condicionais: `if`, `unless`, `case` e `cond` |
| [`02-exceptions`](03-control-flow/02-exceptions/) | Exceções: `raise`, `try/rescue`, `throw` e `exit` |
...
| Pasta | Conteúdo |
|-------|----------|
| [`01-spawning-processes`](04-processes/01-spawning-processes/) | Spawn de múltiplos processos concorrentes |
| [`02-message-passing`](04-processes/02-message-passing/) | Comunicação entre processos: envio simples e coleta de respostas |
| [`03-links-and-monitors`](04-processes/03-links-and-monitors/) | Tratamento de falhas com `spawn_link` e `spawn_monitor` |
| [`04-game-of-stones-server`](04-processes/04-game-of-stones-server/) | Servidor de estado para o jogo Game of Stones usando processos puros |
| [`05-game-of-stones-complete`](04-processes/05-game-of-stones-complete/) | Versão completa do jogo com cliente e servidor |
...
|-------|----------|-----------|
| [`01-genserver-intro`](05-genserver/01-genserver-intro/) | Primeiro GenServer, estado inicial | `init/1` |
| [`02-genserver-init-validation`](05-genserver/02-genserver-init-validation/) | Validação do estado inicial com guards | `init/1` |
| [`03-genserver-calculator`](05-genserver/03-genserver-calculator/) | Calculadora stateful | `init/1`, `handle_call/3`, `handle_cast/2`, `terminate/2` |
| [`04-game-of-stones`](05-genserver/04-game-of-stones/) | Jogo interativo com cliente e servidor | `init/1`, `handle_call/3`, `terminate/2` |
...
| Pasta | Conteúdo |
|-------|----------|
| [`game_of_stones`](06-mix-tool/game_of_stones/) | Game of Stones como projeto Mix completo com escript e terminal colorido via `bunt` |
...
| Pasta | Conteúdo |
|-------|----------|
| [`01-game_of_stones_supervised`](07-fault-tolerance/01-game_of_stones_supervised/) | Game of Stones com Supervisor: Server reinicia automaticamente ao falhar |
| [`02-game_of_stones_ets`](07-fault-tolerance/02-game_of_stones_ets/) | Evolução com ETS: estado do jogo sobrevive ao reinício do Server |
